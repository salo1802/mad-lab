class Profesor {
    ...
    this.sombra[9] = loadImage("./data/tutorial8.png");
    this.sombra[10] = loadImage("./data/tutorial9.png");
    this.sombra[11] = loadImage("./data/tutorial10.png");
    this.sombra[12] = loadImage("./data/tutorial1.png");
    this.sombra[13] = loadImage("./data/tutorial1.png");
    ...
    this.frasesTurorial[9] = ("Ten cuidado con"+"\n"+"con tus procesos\ny tu limpieza" + "\n" + "o vas a crear" + "\n" 
    +"compuestos peligrosos");
  
    this.frasesTurorial[10] = ("Si creas un"+"\n"+"compuesto peligroso" + "\n" + "perderás muchos puntos \ny deberás eliminarlo");

    this.frasesTurorial[11] = ("Puedes consultar"+"\n"+"el libro por" + "\n" + "pista pero se te" +"\n"+ "descontarán puntos"
    + "\n" + "cada que lo uses");

    this.frasesTurorial[12] = ("Para pasar de nivel"+"\n"+"arrastra el" + "\n" + "compuesto hacia mi");

    this.frasesTurorial[13] = ("Estas list@?");
